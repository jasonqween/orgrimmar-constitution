...
|------|------|-------|----------|
| **coordinator** | Оркестрация, маршрутизация | Распределять задачи, ревьюить планы | Давать задачи агентам вне своего сервера |
...
| 2 попытки фикса провалились | L2 | Стоп, доклад принцу |
| Сервер/агент недоступен | L2 | devops чинит; если devops недоступен -> coder |
| Бюджет > $20 за задачу | L3 | Стоп, одобрение принца |
