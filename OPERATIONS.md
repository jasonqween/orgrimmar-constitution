...
| **WATCHLIST** | `memory/warm/WATCHLIST.md` | Личные наблюдения агента: идеи, ресёрч, гипотезы во время работы | Дописать (append) |
...
- Идеи и ресёрч -- НЕ сюда, только в WATCHLIST.md
...
| Что | Куда |
|-----|------|
| Идея от вождя (проектная) | `shared/tasks/ideas/` через `idea-capture.sh` |
| Наблюдение агента во время работы | `memory/warm/WATCHLIST.md` |
| Идея из WATCHLIST стала проектной | Перенести в `shared/tasks/ideas/` + удалить из WATCHLIST |
...
- Писать идеи/ресёрч в WARM (только в WATCHLIST)
