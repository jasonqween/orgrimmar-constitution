...
|------|------|-------|----------|
| **coordinator** | Оркестрация, маршрутизация | Распределять задачи агентам Sylvanas, ревьюить планы, мониторить все серверы. Тралл/Иллидан -- только через control-plane git или принца | Править архитектурные решения coder'а. Командовать devops по инфраструктуре |
