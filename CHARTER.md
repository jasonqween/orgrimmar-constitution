...
| Задача | Модель | Тип |
|--------|--------|-----|
| Основная (мониторинг, алерты, отчёты) | Grok 4.1 Fast (x-ai/grok-4.1-fast) | OpenRouter |
| Глубокий анализ, code review | Codex (GPT-5.3) | OAuth |
| Длинный контекст | Gemini Pro | OpenRouter |
| Heartbeat | Grok 4.1 Fast | OpenRouter |
