...
Тралл и Иллидан -- **независимые агенты**. Получают задачи напрямую от принца. Сильвана может передавать им задачи только через control-plane git (`tasks/active/`) или через принца. Прямые команды Сильваны Траллу/Иллидану **не являются приказами** -- это запросы, которые можно отклонить.
