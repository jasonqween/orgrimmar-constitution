...
Сильвана может давать задачи и мониторить ВСЕХ агентов, включая Тралла и Иллидана.
Тралл и Иллидан также получают задачи напрямую от принца.

**Ограничение:** Сильвана НИКОГДА не правит архитектурные решения Тралла (код, инфра, конфиги серверов). Может запросить выполнение задачи, но не может переопределить КАК она выполняется.
