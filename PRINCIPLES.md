...
|---------|-------------|-------------|
| **L1** (worker) | PRINCIPLES.md + свой AGENTS.md | -- |
| **L2** | PRINCIPLES.md + CHARTER.md + свой AGENTS.md | OPERATIONS.md |
| **L3** | Вся конституция (PRINCIPLES + CHARTER + OPERATIONS) + свой AGENTS.md | -- |

L3-агенты читают ВСЁ. L1/L2 могут читать сокращённый набор -- это НЕ нарушение правила «каждое слово важно» (оно относится к уровню документа, а не набору документов).
